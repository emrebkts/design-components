...
gulp.task('copy-v2', function() {
    return gulp.src("src/v2/**/*.html")
        .pipe(data(function(file) {
            const filename = file.path.split('/').pop();
            const page = filename.split('.')[0];
            return {
...
gulp.task('copy', gulp.parallel('copy-html', 'copy-pages', "copy-v2", 'copy-css', 'copy-js'));
...
gulp.task('watch', function() {
    ...
    gulp.watch("src/**/*.html" , gulp.series(["copy-html" , "copy-pages" , "copy-v2"]));
